...
namespace ShadowGroveGames.LoginWithDiscord.Scripts.Communication.DTO.DataTypes
{
    ...
    {
        /// <summary>
        /// Gets a blank <see cref="GuildPermissions"/> that grants no permissions.
        /// </summary>
        public static readonly GuildPermissions None = new GuildPermissions();

        /// <summary>
        /// Gets a <see cref="GuildPermissions"/> that grants all guild permissions for webhook users.
        /// </summary>
        public static readonly GuildPermissions Webhook = new GuildPermissions(0b0_00000_0000000_0000000_0001101100000_000000);

        /// <summary>
        /// Gets a <see cref="GuildPermissions"/> that grants all guild permissions.
        /// </summary>
        public static readonly GuildPermissions All = new GuildPermissions(ulong.MaxValue);

        /// <summary>
        /// Gets a packed value representing all the permissions in this <see cref="GuildPermissions"/>.
        /// </summary>
        ...
        /// <summary>
        /// If <c>true</c>, a user may view the guild insights.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="GuildPermissions"/> structure with the provided permissions.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="GuildPermissions"/> from this one, changing the provided non-null permissions.
        /// </summary>
